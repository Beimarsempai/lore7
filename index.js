	...
	case 'hidetag':
       ...
       /*case 'ownergrup':
		...
		if (budy.includes(`fua`)) {
				  ...
				  (budy === 'BOT') ||
				  (budy === 'Bot')) {
				  buf = fs.readFileSync(`./imagenes/lala17.mp3`)
				  tiringa.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
				  }
				  if ((budy === "/pack") ||
				  (budy === "pack")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (1).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack1") ||
				  (budy === "pack1")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (2).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack2") ||
				  (budy === "pack2")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (4).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack3") ||
				  (budy === "pack3")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (5).jpg`)
				  tiringa.sendMessage(from, cleitu, sticker, {quoted: mek})
				  }
				  if ((budy === "/pack4") ||
				  (budy === "pack4")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (6).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack5") ||
				  (budy === "pack5")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (7).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack6") ||
				  (budy === "pack6")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (8).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack7") ||
				  (budy === "pack7")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (9).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack8") ||
				  (budy === "pack8")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (10).jpg`)
				  tiringanga.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack9") ||
				  (budy === "pack9")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (11).jpg`)
				  tiringanga.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack10") ||
				  (budy === "pack10")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (12).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack11") ||
				  (budy === "pack11")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (13).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack12") ||
				  (budy === "pack12")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (14).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack13") ||
				  (budy === "pack13")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (15).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack14") ||
				  (budy === "pack14")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (16).jpg`)
				  tiringanganga.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack15") ||
				  (budy === "pack15")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (17).jpg`)
				  tiringanganga.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack16") ||
				  (budy === "pack16")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (18).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack17") ||
				  (budy === "pack17")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (19).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack18") ||
				  (budy === "pack18")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (20).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack19") ||
				  (budy === "pack19")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (21).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack20") ||
				  (budy === "pack20")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (22).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack21") ||
				  (budy === "pack21")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (23).jpg`)
				  tiringanga.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack22") ||
				  (budy === "pack22")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (24).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack23") ||
				  (budy === "pack23")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (25).jpg`)
				  tiringanga.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack24") ||
				  (budy === "pack24")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (26).jpg`)
				  tiringa.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack25") ||
				  (budy === "pack25")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (27).jpg`)
				  tiringanganganga.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack26") ||
				  (budy === "pack26")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (28).jpg`)
				  tiringanganga.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack27") ||
				  (budy === "pack27")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (29).jpg`)
				  tiringanganga.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack28") ||
				  (budy === "pack28")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (30).jpg`)
				  tiringanganganga.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "/pack29") ||
				  (budy === "pack29")) {
				  cleitu = fs.readFileSync(`./imagenes/R18 (31).jpg`)
				  tiringanga.sendMessage(from, cleitu, image, {quoted: mek})
				  }
				  if ((budy === "pruebaaaaaaaaaa") ||
				  (budy === "PRUEBAAAAA")) {
				  cleitu = fs.readFileSync(`./teste/cleito.webp`)
				  tiringanga.sendMessage(from, cleitu, sticker, {quoted: mek})
				  }
